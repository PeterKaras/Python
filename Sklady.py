            ...
            for j in range(self.lenght):
                if i == self.width-1:
                    if self.envi[i][j] == "$" or self.envi[i][j].upper() == "X":
                        self.linear_append(i,j)
                    elif j < self.lenght-1 and (self.envi[i][j+1] == "$" or self.envi[i][j+1] == "X"):
                        self.linear_append(i,j)
                    else:
                        self.distance_counter_line(i,j)
                        
                elif self.envi[i][j] == "$" or self.envi[i][j].upper() == "X":
